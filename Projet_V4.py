...
def display():
    variable = input('Choisir Température, Bruit, Luminosité, CO2, Humidité, Humidex : ')
    
    if variable not in ['Température','Bruit','Luminosité', 'CO2', 'Humidité','Humidex'] :
    ...
    if (numero in ['1','2','3','4','5','6'])==True:
       ...
       # Problème
        if start_date<date_min or end_date>date_max :
            return('Dates ou heures non valides')
