...
def anomalies():
    ...
    if (numero in ['1','2','3','4','5','6'])==True:
        ...
        t = date_min
        delta = pd.Timedelta( hours = 1 ) #Solène tu peux changer en hours = ... ou minutes =...
        anomalies = []
        points_anomalies = []
        max_jour = []
        min_jour = []
...
def display():
    ...
    if (numero in ['1','2','3','4','5','6'])==True:
        ...
        time_anomalies, pos_anomalies = anomalies()
...
def Correlation():
    ...
    if (numero in ['1','2','3','4','5','6'])==True:
        ...
        plt.gcf().subplots_adjust(left = 0.1, bottom = 0.5, right = 0.9, top = 0.95, wspace = 0, hspace = 0)
        plt.plot(time, capteur_numero[var1])
        plt.plot(time, capteur_numero[var2])
        ...
        plt.annotate('indice de corrélation :', xycoords = 'figure fraction', xy = (0.35, 0.09), fontsize=10, color = 'g', backgroundcolor = 'white')
        plt.annotate(correlation, xycoords = 'figure fraction', xy = (0.65,0.09), fontsize=10, color = 'blue', backgroundcolor = 'white')
        plt.show()
